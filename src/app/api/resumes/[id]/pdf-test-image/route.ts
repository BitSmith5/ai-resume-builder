...
export async function GET(
  ...
  console.log('Image PDF generation function started');
  ...
  try {
    ...
    console.log('Resume data for image generation:', {
    ...
    console.log('Using template for image generation:', template);

    // For now, just return JSON to confirm the data is working
    console.log('Data processed successfully');

    // Return the processed data for testing
    return NextResponse.json({
      success: true,
      message: 'Data processing successful - ready for PDF generation',
      data: {
        title: resumeData.title,
        jobTitle: resumeData.jobTitle,
        hasProfilePicture: !!resumeData.profilePicture,
