...
export async function GET(
  ...
  console.log('Final PDF generation function started');
  ...
  try {
    ...
    console.log('Resume data for final PDF generation:', {
    ...
    console.log('Using template for final PDF generation:', template);
    ...
    // Try using a free browser service to convert HTML to PDF
    console.log('Attempting to convert HTML to PDF using browser service...');
    ...
    return NextResponse.json(
      { error: 'Failed to generate final PDF', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
  }
} 